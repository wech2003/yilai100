	...
	<div class="row">
		<div class="col-sm-12">
			<ol class="breadcrumb" style="margin-top: 10px; margin-bottom: 10px;">
				...
				<li><a href="<%=request.getContextPath()%>/jsp/gongshangSub/zhuce.jsp">公司注册</a></li>
			</ol>
		</div>
	</div>
</div>
...
<div class="main-container visa-detail">
	<div class="container">
		<div class="row" style="position: relative;">
			<div class="col-xs-12">
				<h2 class="h4"><strong>公司注册基本流程</strong></h2>
			</div>
			<div class="col-xs-4 col-sm-2 visa-step">
				<div class="thumbnail">
					<img src="<%=request.getContextPath()%>/images/step1.jpg" alt="注册方案制定">
					<div class="caption">
						<h5>1</h5>
						<p>注册方案制定</p>
					</div>
			...
			<div class="col-xs-4 col-sm-2 visa-step">
				<div class="thumbnail">
					<img src="<%=request.getContextPath()%>/images/step2.jpg" alt="完成核名">
					<div class="caption">
						<h5>2</h5>
						<p>完成核名</p>
					</div>
			...
			<div class="col-xs-4 col-sm-2 visa-step">
				<div class="thumbnail">
					<img src="<%=request.getContextPath()%>/images/step3.jpg" alt="领取营业执照">
					<div class="caption">
						<h5>3</h5>
						<p>领取营业执照</p>
					</div>
			...
			<div class="col-xs-4 col-sm-2 visa-step">
				<div class="thumbnail">
					<img src="<%=request.getContextPath()%>/images/step4.jpg" alt="完成刻章">
					<div class="caption">
						<h5>4</h5>
						<p>完成刻章</p>
					</div>
			...
			<div class="col-xs-4 col-sm-2 visa-step">
				<div class="thumbnail">
					<img src="<%=request.getContextPath()%>/images/step5.jpg" alt="办理税务登记">
					<div class="caption">
						<h5>5</h5>
						<p>办理税务登记</p>
					</div>
			...
			<div class="col-xs-4 col-sm-2 visa-step">
				<div class="thumbnail">
					<img src="<%=request.getContextPath()%>/images/step6.jpg" alt="银行开户">
					<div class="caption">
						<h5>6</h5>
						<p>银行开户</p>
					</div>
			...
			<div class="col-xs-12">
				...
				<div class="doc-list">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#new" aria-controls="employee" role="tab" data-toggle="tab">新公司注册</a></li>
                    </ul>
                    <!-- Tab panes -->
